  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 w-full h-full">
        ...
        >
          <source
            src="/videos/7020018_Particle_Dot_1920x1080.mp4"
            type="video/mp4"
          />
        </video>
      ...
      {/* Gradient Orbs - keeping for extra visual depth */}
      <div className="absolute top-20 left-1/4 w-[500px] h-[500px] bg-gradient-to-br from-[#D5AF34]/15 to-[#FFD700]/8 rounded-full blur-3xl animate-blob"></div>
      <div className="absolute top-40 right-1/4 w-[400px] h-[400px] bg-gradient-to-br from-[#5F9EA0]/10 to-[#4A7D7F]/8 rounded-full blur-3xl animate-blob animation-delay-2000"></div>
      <div className="absolute bottom-20 left-1/3 w-[450px] h-[450px] bg-gradient-to-br from-[#E6D5B8]/20 to-[#D5AF34]/8 rounded-full blur-3xl animate-blob animation-delay-4000"></div>
                  ...
                  <div className="flex flex-col h-full justify-between">
                    <div>
                      ...
                      <p className="text-gray-600 leading-relaxed">
                        Accelerate your business with data-driven strategies and
