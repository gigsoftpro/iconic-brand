...
import { HiLightningBolt, HiStar, HiUsers, HiTrendingUp, HiCheckCircle, HiArrowRight } from 'react-icons/hi';
import { FaAward, FaRocket, FaHandshake, FaChartLine, FaGlobe, FaCertificate, FaShieldAlt } from 'react-icons/fa';
...
export default function AboutPage() {
  ...
  const leadership = [
    ...
    },
    {
      ...
      bio: "Larry Zhao is a seasoned financial strategist with a career spanning over two decades in corporate finance, investment management, and business development. His expertise lies in building strong financial infrastructures, optimizing profitability, and guiding companies through every stage of growth; from early-stage startups to mature enterprises. Known for his precision and foresight, Larry has successfully led financial operations for multinational organizations, private equity firms, and emerging ventures, helping them scale sustainably while maintaining fiscal discipline. As Chief Financial Officer of Iconic Brand Group, Larry provides the financial vision and strategic insight that empower businesses to grow with confidence. His deep understanding of capital structure, forecasting, and financial modeling makes him the ideal advisor for companies ready to accelerate their market expansion and long-term value creation.",
      image: "/team/larry-zhao.png"
    },
    {
      name: "Neil Baumann",
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center pt-[7.25rem]">
          ...
          <p className="text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
            We&apos;re not just consultants or marketers—we&apos;re your strategic
            partners in building brands that stand the test of time
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Industry veterans with decades of combined experience driving growth and innovation
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {leadership.map((member, i) => (
              <div key={i} className="group bg-white rounded-2xl overflow-hidden shadow-xl border border-gray-200 hover:shadow-2xl transition-shadow duration-300">
                ...
                <div className="p-6">
                  <p className="text-gray-600 leading-relaxed text-sm">
                    ...
                    {member.link && (
                      <>
                        {' '}<a href={member.link.url} target="_blank" rel="noopener noreferrer" className="text-[#D5AF34] underline hover:text-[#5F9EA0] transition-colors">{member.link.label}</a>
                      </>
                    )}
                  </p>
                </div>
      ...
      <section className="py-24 px-6 bg-gradient-to-b from-white via-[#F8F8F8] to-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Strategic advisors and industry experts who guide our vision and enhance our capabilities
            </p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {advisors.map((advisor, i) => (
              <div key={i} className="group bg-white rounded-xl border border-gray-200 p-4 hover:border-[#D5AF34] hover:shadow-lg transition-all duration-300">
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs text-[#D5AF34] font-semibold mb-2">{advisor.role}</p>
